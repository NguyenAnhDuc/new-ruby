...
(function($) {
	...
	$.confirm = function(options, e) {
		var question = $('#currentqs').val();
		var domain = $('#result-domain').html();
		var intent = $('#result-intent').html();
		var answer = $('#result-final').html();
		var settings = $.extend({
			//text : "Are you sure?",
			text : "Bạn muốn report cho câu hỏi: </br>" + question,
			title : "",
			confirmButton : "Yes",
			cancelButton : "Cancel",
			post : false,
			confirm : function(o) {
				...
				.ajax({
					...
					success : function(result) {
						if (result === "success") alert("Many thanks for your report!");
						else alert("Sorry, could not report this time");
					},
					error : function(result) {
						alert("Error! Something went wrong. Sorry!");
					}
				});
